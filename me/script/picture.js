...
function anim() {
  ...
  if (sakura.getBoundingClientRect().top > 0) {
    ...
    sakura1.style.width = `calc(70% + ${windowHeight - sakura.getBoundingClientRect().top * 2}px)`
    sakura.style.padding = `30px calc(15% - ${
      windowHeight - sakura.getBoundingClientRect().top
    }px)`
  }
}
